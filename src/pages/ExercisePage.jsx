...
Een veelvoorkomend subnetmask is 255.255.255.0, wat betekent dat alle apparaten met een adres dat begint met 192.168.1.x binnen hetzelfde netwerk zitten.`,
  buttonText: "✅ Voltooid",
  tip: "Een subnetmask bepaalt de netwerkstructuur.",
}
,
...
Als je antwoord krijgt, is de verbinding succesvol.`,
    ...
    {
      title: "Race tegen je klasgenoten!",
    ...
    <div className="flex flex-col items-center min-h-screen bg-gradient-to-r from-purple-700 to-blue-500">
      ...
      <div className="bg-white p-8 rounded-xl shadow-xl max-w-2xl w-full mt-6">
        ...
        <p className="text-center mb-6 text-lg text-gray-600 font-semibold">
          ...
          <div
            key={index}
            className={`p-6 border rounded-lg mt-4 transition-all duration-300 transform ${
              index > currentTask ? "hidden" : "bg-gray-100 hover:scale-105 hover:shadow-lg"
            }`}
          >
            ...
            {/*knoppen alleen tonen behalve laatste opdracht*/}
