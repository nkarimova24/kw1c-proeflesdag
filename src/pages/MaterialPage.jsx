...
{/* Uitleg over regels en functionaliteiten pagina 
    Geen timer inbegrepen */}
    ...
    <div className="flex items-center justify-center min-h-screen bg-blue-950">
      <div className="bg-white p-8 rounded-xl shadow-xl max-w-2xl w-full mt-6 text-gray-800">
        ...
        <ul className="list-disc list-inside mb-4 text-gray-700">
            {/*We kunnen dit nog aanpassen per ding dat je wilt uitleggen, ipv een list*/}
          <li>Regel / Functionaliteit</li>
          <li>Regel / Functionaliteit</li>
          <li>Regel / Functionaliteit</li>
        </ul>
        {/*user wordt doorverwezen naar de volgende pagina*/}
